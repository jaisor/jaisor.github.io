...
export const tags: Tag[] = [
  {
    ...
    icon: Code2,
    description:
      "I build to stay tech-urrent and keep my hands on actual code. Most of my projects are paired with some kind of hardware, or with a way to visualize data that satisfies my need for eye-candy dashboards.",
