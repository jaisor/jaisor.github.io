...
const post: Post = {
  ...
  image: warlockHero,
  imageAlt:
    "Close-up of a white 3D-printed B.C. Rich Warlock guitar body covered in red blood-splatter paint, with a white humbucker, a black double-locking tremolo, and an engraved Death logo beside the bridge.",
  body: [
